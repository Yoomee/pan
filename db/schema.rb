...
ActiveRecord::Schema.define(:version => 20120423103244) do
  ...
  create_table "tours", :force => true do |t|
    ...
    t.boolean  "blackout_needed"
    t.boolean  "uses_lighting"
    t.boolean  "uses_own_lighting"
    t.boolean  "uses_sound"
    t.boolean  "suits_arts_venue"
    t.boolean  "suits_village_hall"
    t.boolean  "suits_school_hall"
    t.boolean  "suits_outdoors"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
